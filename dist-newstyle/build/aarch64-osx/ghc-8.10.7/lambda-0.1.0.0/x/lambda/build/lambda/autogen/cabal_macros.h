...
/* package lambda-0.1.0.0 */
#ifndef VERSION_lambda
#define VERSION_lambda "0.1.0.0"
#endif /* VERSION_lambda */
#ifndef MIN_VERSION_lambda
#define MIN_VERSION_lambda(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "lambda-0.1.0.0-inplace-lambda"
